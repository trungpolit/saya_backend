        ...
        <div class="ibox float-e-margins">
            <div class="ibox-content">
                ...
                <div class="form-group <?php echo $name_err_class ?>">
                    <label class="col-sm-2 control-label"><?php echo __('bundle_name') ?> <?php echo $this->element('required') ?></label>
                ...
                <div class="form-group <?php echo $description_err_class ?>">
                    <label class="col-sm-2 control-label"><?php echo __('bundle_description') ?></label>
                ...
                <div class="form-group <?php echo $weight_err_class ?>">
                    <label class="col-sm-2 control-label"><?php echo __('bundle_weight') ?></label>
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label"><?php echo __('bundle_status') ?></label>
